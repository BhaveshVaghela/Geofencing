...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener
{
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch (item.getItemId())
        {
            ...
            case R.id.action_stop_monitor:
                ...
                break;
            case R.id.meter_100:
                GEOFENCE_RADIUS_IN_METERS = 100;
                updateArea();
                break;
            case R.id.meter_200:
                GEOFENCE_RADIUS_IN_METERS = 200;
                updateArea();
                break;
            case R.id.meter_400:
                GEOFENCE_RADIUS_IN_METERS = 400;
                updateArea();
                break;
            case R.id.meter_600:
                GEOFENCE_RADIUS_IN_METERS = 600;
                updateArea();
                break;
            case R.id.meter_800:
                GEOFENCE_RADIUS_IN_METERS = 800;
                updateArea();
                break;
    ...
    private void drawCircle()
    {
        ...
        Log.e("asdadad","GEOFENCE_RADIUS_IN_METERS "+GEOFENCE_RADIUS_IN_METERS);
